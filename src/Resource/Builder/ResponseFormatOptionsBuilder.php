...
/**
 * Class ResponseFormatOptionsBuilder
 *
 ...
 */
class ResponseFormatOptionsBuilder extends AbstractControllerBuilder
{
    /**
    ...
    public function build($resourceControllerKey, $default = null)
    {
        ...
        if(empty($controllerConfig['service'])) {
            $controllerConfig = $this->getDefaultOptions()->get('controller');
